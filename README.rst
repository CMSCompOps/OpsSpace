...
This way, viewers on GitHub can also see your ``README.rst`` on the package homepage.
...
If you need to add a path for importing isolated python scripts, edit the ``docs/conf.py`` file
to append your directory to the path.
The paths are relative to inside the ``docs`` directory.
