...
To test generating documentation for your new tools, you will need virtualenv installed::

    pip install virtualenv

Using the ``test/test_build_docs.sh`` directory, you can then build the documentation from fresh environment.
This is to mimic the automated documentation building procedure on
...
To add a new page to our documentation, create a new ``.rst`` file (or softlink to a file),
...
This way, viewers on GitHub can also your package's documentation on the package homepage.
...
.. note::
  ...
  Be sure to test your document generation with sphinx.
